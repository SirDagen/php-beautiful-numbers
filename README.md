...
When initialising you call the constructor specifying at least the tongue you want to use it in, and maybe further options like accuracy, number format etc. (see quick manual inside class file).  
