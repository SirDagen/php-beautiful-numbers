...
*php-beautiful-numbers* is a rather small but helpful class (< 15 kB with annotations). It handles numbers in a way that the output are pretty, easy human readable numbers. 
