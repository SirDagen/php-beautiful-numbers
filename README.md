...
*Ann.: We use an array for the language part so that it is easier to implement* php-beautiful-numbers *in multi-language websites, like tnum($val, $LANG['de']['baum-AKK']) for German accusative form as in ["Bäume", "einen Baum"].*
