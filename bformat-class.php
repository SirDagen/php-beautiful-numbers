...
echo "<p>".$bf->sinum($val, $u, ['acc'=>2])." &nbsp;(= {$val} {$u})</p>"; // Genauigkeit = 2 Stellen
...
for ($i=0;$i<3;$i++) {
    $val=mt_rand(2, 15); 
    echo "Es sind ".$bf->tnum($val)." Bäume auf der Anhöhe.<br/>"; 
}
echo "</p>"; 
...
echo "<p>Das Mittel liegt bei ".$bf->tnum($val, 1)." Kindern.</p>"; 
